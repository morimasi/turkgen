...
const Logo: React.FC = () => (
    <div className="flex items-center justify-center h-10 w-10 rounded-lg bg-primary-600 shadow-md">
        <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M12.5 7.5L11.25 10.5L8 11.25L11.25 12L12.5 15L13.75 12L17 11.25L13.75 10.5L12.5 7.5Z" fill="rgb(var(--color-primary-100))" opacity="0.8"></path>
        </svg>
    </div>
);
